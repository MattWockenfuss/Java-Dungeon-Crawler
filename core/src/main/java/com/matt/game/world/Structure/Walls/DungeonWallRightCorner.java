...
public class DungeonWallRightCorner extends Wall {
    public DungeonWallRightCorner(byte ID) {
        super(new Texture(Gdx.files.internal("tiles/wall_1_corner.png")), ID, (byte) 3);
